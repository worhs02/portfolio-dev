    ...
    changelog: [
      {
        ...
        changes: [
          ...
          'GPT 연동 해양 도감 기능',
          '아바타 & 나의 바다 성장 시스템',
          'OAuth2 소셜 로그인 (Apple, Kakao)',
          'S3 이미지 업로드 및 WebP 변환'
        ]
      }
    ]
  },
    ...
    changelog: [
      {
        ...
        date: '2025-02-20',
        changes: [
          'Library 화면 구현 (재생목록, 노래, 앨범, 아티스트)',
          'MyPage + Recap 기능',
          '커스텀 Carousel View 구현',
          '커스텀 DatePicker 구현',
          'MVC 패턴 적용'
        ]
      }
    ...
    changelog: [
      {
        ...
        date: '2026-01-11',
        changes: [
          'WebSocket (STOMP) 실시간 통신 서버 구축',
          '게임 Phase 관리 (Lobby → Flee → Main → Result)',
          '검거/구출 인터랙션 API',
          'Redis 기반 비로그인 세션 시스템',
          'PUB/SUB 구조 실시간 상태 동기화'
        ]
      }
    ]
  },
